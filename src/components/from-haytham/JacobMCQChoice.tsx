...
export const IncorrectChoice: React.FC<{
  ...
  const [isChosen] = useState(false);

  // Style for the button
  const buttonStyle: string = isChosen ? "choice-button incorrect-button" : "choice-button initial-button";

  // Component Being Rendered
  return (
    <IonButton className={buttonStyle} disabled={clicked}>
...
export const CorrectChoice: React.FC<{
  ...
  // Style for the button
  const buttonStyle: string = clicked ? "chocie-button correct-button" : "choice-button initial-button";
